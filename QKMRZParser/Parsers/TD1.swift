...
class TD1 {
    ...
    let birthDateLocal: String

    let expiryDateLocal: String
    ...
    lazy var result: QKMRZResult = {
        ...
        return QKMRZResult(
            ...
            birthDateString: birthDateLocal,

            sex: sex.value as! String?,

            expiryDate: expiryDate.value as! Date?,

            expiryDateString: expiryDateLocal, personalNumber: optionalData.value as! String,
    ...
    init(from mrzLines: [String], using formatter: MRZFieldFormatter) {
        ...
        birthDateLocal = birthDate.rawValue
        ...
        expiryDateLocal = expiryDate.rawValue
